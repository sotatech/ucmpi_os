...
# This package does not come with Debian Trixie, so clone and build pigpio. Not needed for earlier Debian versions.
# See here for correct method to manually install pigpiod: https://github.com/joan2937/pigpio/issues/632
